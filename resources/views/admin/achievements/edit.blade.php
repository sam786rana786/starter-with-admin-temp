                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('achievement.update', $achievement->id) }}" enctype="multipart/form-data"
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <select class="form-control" name="year">
                                            ...
                                            @foreach ($years as $year)
                                                <option value="{{ $year }}"
                                                    {{ $achievement->year == $year ? 'selected' : '' }}>{{ $year }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <img id="showImage"
                                            src="{{ !empty($achievement->photo) ? url($achievement->photo) : url('backend/images/small/img-2.jpg') }}"
